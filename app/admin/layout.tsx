...
export default async function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen flex">
      <nav className="w-56 bg-gray-900 text-white flex flex-col gap-1 p-4">
        ...
        <Link href="/admin/teachers" className="px-3 py-2 rounded hover:bg-gray-700 text-sm">老師管理</Link>
